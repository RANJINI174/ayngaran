        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">Add Marketing Supervisor</div>
                </div>
                <div class="card-body">
                    <form id="Add_marketingSupervisorForm" class="p-3" autocomplete="off">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="hidden" id="url" value="{{ route('marketing_supervisor_store') }}">
                                  <?php
