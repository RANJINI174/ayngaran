    ...
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="Edit_directorForm" class="p-3" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="reference_code" id="reference_code"
                                        value="{{ !empty($director->reference_code) ? $director->reference_code : '' }}"
                                        readonly>
                                </div>
                            ...
                            <div class="col-md-4">
                               ...
                               <div class="input-group">
                                    <input type="text" class="form-control" name="name" id="name"
                                        placeholder="Name" value="{{ !empty($director->name) ? $director->name : '' }}">
                                </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="team_name" id="team_name"
                                        placeholder="Team Name" value="{{ !empty($director->team_name) ? $director->team_name : '' }}">
                                </div>
                                <span style="display:none" class="text-danger" id="team_name_validation">Team Name Field is Required</span>
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="email" id="email"
                                        placeholder="Email" value="{{ !empty($director->email) ? $director->email : '' }}">
                                </div>
                            ...
                            <?php 
                                $decrypt_password = '';
                                if (!empty($director->encrypt_password) && $director->encrypt_password != null) {
                                    $decrypt_password = \Illuminate\Support\Facades\Crypt::decrypt($director->encrypt_password);
                                }
                            ?>
                            <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="father_husband_name" id="father_husband_name"
                                        placeholder="Father Name / Husband Name" value="{{ !empty($director->father_husband_name) ? $director->father_husband_name : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Branch <span class="text-red">*</span></label>
                                  <div class="input-group">
                                     <select name="branch_id" id="branch_id" class="form-control SlectBox">
                                        ...
                                        <option value="{{ $branches->id }}" @if($director->branch_id == $branches->id) {{ "selected" }}   @endif >{{ $branches->branch_name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    </div><input class="form-control fc-datepicker"  type="date"
                                        name="join_date" id="join_date" value="{{ !empty($director->join_date) ? $director->join_date : '' }}">
                                </div>
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select name="marrital_status" id="marrital_status" class="form-control SlectBox">
                                        ...
                                        <option value="1" @if($director->marrital_status == 1) {{ "selected" }}   @endif>Married</option>
                                        <option value="0" @if($director->marrital_status == 0) {{ "selected" }}   @endif>Un Married</option>
                                    </select>
                                </div>
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <div class="input-group-text">
                                     ...
                                     value="{{ !empty($director->wedding_date) ? $director->wedding_date : '' }}" type="date"
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="nominee_name" id="nominee_name"
                                        placeholder="Nominee Name" value="{{ !empty($director->nominee_name) ? $director->nominee_name : '' }}">
                                </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="input-group">
                                   <select name="relationship" id="relationship" class="form-control SlectBox">
                                        ...
                                        <option value="{{ $relation->id }} " @if($relation->id == $director->relationship) {{ "Selected" }} @endif>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="nominee_mobile" id="nominee_mobile"
                                        placeholder="Nominee Mobile" value="{{ !empty($director->nominee_mobile) ? $director->nominee_mobile : '' }}">
                                </div>
                                ...
                                <div class="input-group">
                                   <select name="designation_id" id="designation_id" class="form-control SlectBox">
                                       <option value="">Select Designation</option>
                                        ...
                                        <option value="{{ $val->id }} " @if($director->designation_id == $val->id) {{ "selected" }} @endif>{{ $val->designation }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <textarea class="form-control mb-4" placeholder="Address" name="address" id="address" rows="3"
                                        cols="50" style="text-align: start;" wrap="virtual">{{ $director->address }}</textarea>
                                </div>
                           ...
                           <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="mobile_no" id="mobile_no"
                                        ...
                                        value="{{ !empty($director->mobile_no) ? $director->mobile_no : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="alternate_mobile" id="alternate_mobile"
                                        ...
                                        value="{{ !empty($director->alternate_mobile) ? $director->alternate_mobile : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <div class="input-group-text">
                                        ...
                                        name="dob" id="dob" value="{{ !empty($director->dob) ? $director->dob : '' }}">
                                </div>
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select name="gender" class="form-control SlectBox">
                                        ...
                                        <option value="1" {{ $director->gender == 1 ? 'selected' : '' }}>Male</option>
                                        <option value="0" {{ $director->gender == 0 ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="pincode" id="pincode"
                                        placeholder="Pincode" value="{{ $director->pincode }}">
                                </div>
                                    ...
                                    <select name="area" id="area" class="form-control SlectBox">
                                        ...
                                        @foreach ($areas as $area)
                                            <option value="{{ $area->id }}"
                                                {{ !empty($area->id == $director->area) ? 'selected' : '' }}>
                                                {{ $area->area }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select name="country_id" class="form-control SlectBox">
                                        ...
                                        <option value="1" {{ $director->country_id == 1 ? 'selected' : '' }}>India
                                        </option>
                                    </select>
                                </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="input-group">
                                     <select name="bank_name" id="bank_name" class="form-control SlectBox">
                                        ...
                                        <option value="{{ $bank->id }} "  @if($director->bank_name == $bank->id) {{ "selected" }} @endif>{{ $bank->bank_name }}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                             ...
                             <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="account_no" id="account_no"
                                        placeholder="Account No" value="{{ !empty($director->account_no) ? $director->account_no : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="ifsc_code" id="ifsc_code"
                                        placeholder="IFSC Code" value="{{ !empty($director->ifsc_code) ? $director->ifsc_code : '' }}">
                                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="bank_branch" id="bank_branch"
                                        placeholder="Bank Branch" value="{{ !empty($director->bank_branch) ? $director->bank_branch : '' }}">
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                   <select name="introduced_by" id="introduced_by" class="form-control SlectBox">
                                        ...
                                        @if(isset($designation))
                                        @foreach($designation as $val)
                                        <option value="{{ $val->id }} " @if($director->introduced_by == $val->id) {{ "selected" }} @endif>{{ $val->designation }}</option>
                                        @endforeach
                                        @endif
                                        <option value="thired_party" @if($director->introduced_by == 'thired_party') {{ "selected" }} @endif>Third Party</option>
                                    </select>
                                </div><small class="text-danger introduced_by"></small>
                            </div>
                            
                            <div class="col-md-4" id="select_introducer" <?php if($director->introduced_by == 'thired_party' || $director->introduced_by == ''){ ?> style="display:none" <?php }else {?>
                            style="display:block" <?php } ?>>
                                ...
                                <div class="input-group">
                                   <select name="introducer" id="introducer" class="form-control SlectBox">
                                       ...
                                       <option value="{{ $introducer->id }}" @if($director->introducer_id == $introducer->id) {{ "Selected" }} @endif>{{ $introducer->name }}</option>
                                        @endforeach
                                        @endif
                                      </select>
                             ...
                             <div class="col-md-4" id="select_introducer_id" <?php if($director->introduced_by == 'thired_party' || $director->introduced_by == ''){ ?> style="display:none" <?php }else {?>
                            style="display:block" <?php } ?>>
                            ...
                            <div class="col-md-4" id="thired_part_1" <?php if($director->introduced_by != 'thired_party'){ ?> style="display:none" <?php }else {?>
                            style="display:block" <?php } ?>>
                                ...
                                <div class="input-group">
                                 <input type="text" class="form-control" name="thired_party_name" id="thired_party_name"
                                        placeholder="Third Party Name" value="{{ !empty($director->thired_party_name) ? $director->thired_party_name : '' }}">
                                </div><small class="text-danger thired_party_name"></small>
                            </div>
                            
                            <div class="col-md-4" id="thired_part_2" <?php if($director->introduced_by != 'thired_party'){ ?> style="display:none" <?php }else {?>
                            style="display:block" <?php } ?>>
                                ...
                                <div class="input-group">
                                 <input type="text" class="form-control" name="thired_party_mobile" id="thired_party_mobile"
                                        placeholder="Third Party Mobile" value="{{ !empty($director->thired_party_mobile) ? $director->thired_party_mobile : '' }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                   <select name="status" id="status" class="form-control SlectBox">
                                        <option value="1" @if($director->status == '1') {{ "selected" }} @endif>Active</option>
                                        <option value="0" @if($director->status == '0') {{ "selected" }} @endif>In Active</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select name="select_type" id="select_type" class="form-control SlectBox">
                                        ...
                                        <option value="1"
                                            @if ($director->select_type == '1') {{ 'selected' }} @endif>Promote</option>
                                        <option value="2"
                                            @if ($director->select_type == '2') {{ 'selected' }} @endif>Demote</option>
                                    </select>
                                </div><small class="text-danger status"></small>
                            </div>
                            <div class="col-md-4" id="promote_div">
                                ...
                                <div class="input-group">
                                    ...
                                    <option value="">Select</option>
                                     @if(isset($designation))
                                     @foreach($designation as $val)
                                     <option value="{{ $val->id }} " @if($director->promote_id == $val->id) {{ "selected" }} @endif>{{ $val->designation }}</option>
                                     @endforeach
                                     @endif
                                    </select>
                                </div><small class="text-danger status"></small>
                                ...
                                <div class="input-group">
                                   <select name="demote_id" id="demote_id" class="form-control SlectBox">
                                    <option value="">Select</option>
                                     @if(isset($designation))
                                     @foreach($designation as $val)
                                     <option value="{{ $val->id }} " @if($director->demote_id == $val->id) {{ "selected" }} @endif>{{ $val->designation }}</option>
                                     @endforeach
                                     @endif
                                    </select>
                                </div><small class="text-danger status"></small>
                        ...
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                ...
                                <a href="{{url('director-lists')}}" class="btn btn-light">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
