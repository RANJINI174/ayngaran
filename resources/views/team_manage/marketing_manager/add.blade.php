    ...
    <div class="row row-sm mt-2">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="Add_marketingmanagerForm" class="p-3" autocomplete="off">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <select name="branch_id" id="branch_id" class="form-control SlectBox">
                                        ...
                                        @if (isset($branch))
                                            @foreach ($branch as $branches)
                                                <option value="{{ $branches->id }} ">{{ $branches->branch_name }}
                                                </option>
                                            @endforeach
                                        @endif
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <span style="display:none" class="text-danger" id="mobile_validation">Mobile No
                                    Already
                                    Exist</span>
                            </div>
                            <div class="col-md-4">
