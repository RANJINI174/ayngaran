        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form id="add_relationshipform" autocomplete="off">
                        @csrf
                        @method('POST')
    ...
    <div class="modal fade" id="edit_relationtmodel">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form id="edit_relationshipform" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
            ...
            <div class="card ">
                <div class="card-header d-flex aligin-items-center justify-content-between">
                    ...
                    @php
                        ...
                        $create_check = $permission->checkPermission('relationship.create');
                    @endphp
                    @if ($create_check == 1)
                                ...
                                @foreach ($relationships as $relationship)
                                    <tr class="border-bottom">
                                        ...
                                        <td class="">
                                             @php
                                                $permission = new \App\Models\Permission();
                                                $edit_check = $permission->checkPermission('relationship.edit');
                                            @endphp
                                            @if($edit_check == 1)
                                            ...
                                            @php
                                                $permission = new \App\Models\Permission();
                                                $delete_check = $permission->checkPermission('relationship.delete');
                                            @endphp
                                            @if($delete_check == 1)
