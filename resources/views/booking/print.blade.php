...
<div style="margin:4cm 0cm 3cm 0cm">
  ...
  border-left: 1px solid black;padding-top:6px !important;padding-bottom:6px !important;">
        <tr>
            ...
            <th style="text-align:end;width: 25%;">
                <b> Date: {{ date('d-m-Y', strtotime($booking->receipt_date)) }}</b>
            </th>
        </tr>
    </table>
 ...
 <table class="custom-table border-bottom-0" width='100%' cellspacing='1' style="border-top: 1px solid black;
 font-size:13px !important;border-right: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black;font-size:13px">
	...
	<table width='100%'  cellspacing='1'  style="border-right: 1px solid black;border-left: 1px solid black;font-size:14px;">
	 <tr>
	     <th style="width: 50%;text-align:center;border-right: 1px solid black;border-bottom: 1px solid black;
	     padding-top:6px !important;padding-bottom:6px !important;">CUSTOMER DETAILS</th>
	     <th style="width: 50%;text-align:center;border-bottom: 1px solid black;
	...
	<td style="width: 50%;text-transform: uppercase;font-size:13px !important;">
	 ...
	 <table class="custom-table border-bottom-0" width='100%'  border='1' bordercolor="black" style="border-collapse: collapse;font-size:13px !important;  ">
	 <tr>
	  <th colspan="7" style="width: 100%;text-align:center;padding-top:6px !important;padding-bottom:6px !important;font-size:14px !important;">PAYMENT DETAILS</th>
	 </tr>
	...
	<tr>
     ...
     <tr>
         <th colspan="6" style="text-align:right !important;padding-right:15px !important;font-size:13px;text-align:right">TOTAL</th>
         <th style="text-align:right">{{ IND_money_format($payment->amount) }}</th>
     </tr>
      <tr>
         <th colspan="6" style="text-align:right !important;padding-right:15px !important;font-size:13px;text-align:right">BALANCE</th>
